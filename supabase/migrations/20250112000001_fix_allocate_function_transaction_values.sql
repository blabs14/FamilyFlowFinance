-- Corrigir a função allocate_to_goal_with_transaction para usar valores positivos com tipos corretos
...
BEGIN
  ...
  BEGIN
    ...
    -- 4. Criar a transação de despesa na conta de origem (valor positivo, tipo despesa)
    ...
    VALUES (
      ...
      'despesa', -- Tipo despesa para indicar saída
      NOW()::date,
    ...
    -- 5. Criar a transação de receita na conta Objetivos (valor positivo, tipo receita)
    INSERT INTO transactions (
      account_id,
      categoria_id,
      valor,
    ...
    VALUES (
      ...
      v_categoria_id,
      v_amount_requested, -- Valor positivo
      'receita', -- Tipo receita para indicar entrada
      NOW()::date,
...
-- Comentário
COMMENT ON FUNCTION public.allocate_to_goal_with_transaction IS 'Aloca fundos de uma conta para um objetivo, movendo o valor para a conta Objetivos e criando as transações correspondentes com valores positivos e tipos corretos';