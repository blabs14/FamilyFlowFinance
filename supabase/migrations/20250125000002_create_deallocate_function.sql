-- Função para desalocar fundos de um objetivo com transação completa
...
-- Comentários
COMMENT ON FUNCTION public.deallocate_from_goal_with_transaction IS 'Desaloca fundos de um objetivo e ajusta os saldos das contas envolvidas';