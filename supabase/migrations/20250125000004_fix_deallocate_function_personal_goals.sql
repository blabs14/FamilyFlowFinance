-- Corrigir função deallocate_from_goal_with_transaction para suportar objetivos pessoais (family_id NULL)
...
-- Comentários
COMMENT ON FUNCTION public.deallocate_from_goal_with_transaction(uuid, uuid, numeric, uuid) IS 'Desaloca fundos de um objetivo e ajusta os saldos das contas envolvidas (suporta objetivos pessoais e familiares)';