-- Migração: Atualizar fn_goal_delete_with_correct_logic para usar coluna operation_key em idempotent_ops
-- Data: 2025-10-09
-- Objetivo: Corrigir referências à coluna antiga "key" e usar "operation_key" para idempotência
