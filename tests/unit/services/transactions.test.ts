...
describe('Transactions Service', () => {
  ...
  describe('createTransaction', () => {
    it('should create transaction successfully', async () => {
      ...
      expect(mockSupabase.from).toHaveBeenCalledWith('transactions');
      // operation_id is auto-generated by createTransaction (unit-06), so use objectContaining
      expect(mockQuery.insert).toHaveBeenCalledWith([expect.objectContaining({ ...newTransaction, user_id: 'user-123' })]);
